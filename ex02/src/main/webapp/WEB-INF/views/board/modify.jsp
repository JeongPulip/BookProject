	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<input type="hidden" name="pageNum"  value='<c:out value="${cri.pageNum }"/>'><input type="hidden" name="amount"  value='<c:out value="${cri.amount }"/>'>
						...
						<div class="form-group">
							...
							<textarea name="content" id="" cols="30" class="form-control"
								rows="3"  ><c:out value="${board.content }"></c:out></textarea>
						</div>
						<div class="form-group">
